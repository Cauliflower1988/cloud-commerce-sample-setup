...
export declare class BackendEntry {
    ...
    matchingPayload?: string | number | boolean | RegExp | Date | Payload | import("../../../dtos").Primitive[] | undefined;
    mock?: BackendRespond;
    constructor(pattern: string | RegExp, matchingPayload?: string | number | boolean | RegExp | Date | Payload | import("../../../dtos").Primitive[] | undefined);
    /**
     * @ngdoc method
