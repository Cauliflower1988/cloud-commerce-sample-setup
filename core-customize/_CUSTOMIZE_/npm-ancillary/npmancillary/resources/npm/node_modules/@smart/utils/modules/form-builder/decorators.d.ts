 ...
 */
export declare const FORM_PROP = "_form_prop_";
/**
 ...
 * @internal
 */
export declare class ControlPropDecorator extends PropDecorator {
}
/**
 ...
 */
export declare function DynamicFormControl(): <C>(target: C, key: string) => void;
/**
