...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash'), require('crypto-js'), require('@angular/core'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators'), require('@ngx-translate/core'), require('@angular/forms'), require('@fundamental-ngx/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@smart/utils', ['exports', 'lodash', 'crypto-js', '@angular/core', '@angular/common/http', 'rxjs', 'rxjs/operators', '@ngx-translate/core', '@angular/forms', '@fundamental-ngx/core', '@angular/common'], factory) :
    (global = global || self, factory((global.smart = global.smart || {}, global.smart.utils = {}), global.lodash, global.cryptoJs, global.ng.core, global.ng.common.http, global.rxjs, global.rxjs.operators, global.core$1, global.ng.forms, global.core$2, global.ng.common));
}(this, (function (exports, lodash, cryptoJs, core, http, rxjs, operators, core$1, forms, core$2, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FunctionsUtils = /** @class */ (function () {
        ...
        FunctionsUtils.prototype.convertToArray = function (obj) {
            return Object.keys(obj).reduce(function (acc, key) { return __spread((acc || []), [
        ...
        LogService.prototype._log = function (requestLevel, msg) {
            ...
            if (requestLevel >= this.logLevel) {
                ...
                if (this._console() && this._console()[method]) {
                    (_a = this._console())[method].apply(_a, __spread(msg));
                }
            }
        };
    ...
    function CacheConfigAnnotationFactory(logService) {
        ...
        return annotationService.setClassAnnotationFactory(cacheConfigAnnotationName, function (factoryArguments) {
            return function (instance, originalConstructor, invocationArguments) {
                originalConstructor.call.apply(originalConstructor, __spread([instance], invocationArguments));
            ...
            return function (target, propertyName, originalMethod, invocationArguments) {
                ...
                if (returnedObject && returnedObject.then) {
                    return returnedObject.then(function (value) {
                        cacheService.evict.apply(cacheService, __spread(tags));
                        return value;
                    });
                }
                else {
    ...
    var DefaultCacheTiming = /** @class */ (function () {
        ...
        DefaultCacheTiming.prototype.setAge = function (_item) {
            var item = __assign({}, _item, { expirationAge: this.expirationAge, refreshAge: this.refreshAge });
            return item;
        };
    ...
    var CacheService = /** @class */ (function () {
        ...
        CacheService.prototype.handle = function (service, methodName, preboundMethod, invocationArguments, cacheActions, tags) {
            ...
            if (!_item) {
                ...
                this.cacheEngine.addItem(item, cacheTiming, preboundMethod.bind.apply(preboundMethod, __spread([undefined], Array.prototype.slice.call(invocationArguments))));
        ...
        CacheService.prototype.evict = function () {
            ...
            (_a = this.cacheEngine).evict.apply(_a, __spread(tags));
        ...
        CacheService.prototype.collectEventNamesFromTags = function (tags) {
            var _this = this;
            if (tags && tags.length) {
                return lodash.union.apply(lodash, __spread(tags.map(function (t) { return _this.collectEventNamesFromTag(t); })));
            }
            else {
                return [];
            }
        ...
        CacheService.prototype.collectEventNamesFromTag = function (tag) {
            var _this = this;
            return lodash.union.apply(lodash, __spread([[tag.event]], (tag.relatedTags ? tag.relatedTags.map(function (t) { return _this.collectEventNamesFromTag(t); }) : [])));
        };
        ...
        CacheService.ctorParameters = function () { return [
            ...
            { type: StringUtils },
            { type: FunctionsUtils },
            { type: undefined, decorators: [{ type: core.Inject, args: [EVENT_SERVICE,] }] },
            { type: CacheEngine }
        ]; };
    ...
    var FlawInjectionInterceptor = /** @class */ (function () {
        ...
        FlawInjectionInterceptor.ctorParameters = function () { return [
            { type: HttpUtils },
            { type: LogService }
        ]; };
    ...
    var RetryInterceptor = /** @class */ (function () {
        ...
        RetryInterceptor.ctorParameters = function () { return [
            ...
            { type: IAlertService },
            { type: BooleanUtils },
            { type: undefined, decorators: [{ type: core.Inject, args: [DefaultRetryStrategy,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [ExponentialRetryStrategy,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [LinearRetryStrategy,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [OPERATION_CONTEXT_TOKEN,] }] }
        ]; };
    ...
    var UnauthorizedErrorInterceptor = /** @class */ (function () {
        ...
        UnauthorizedErrorInterceptor.ctorParameters = function () { return [
            { type: http.HttpClient },
            { type: IAuthenticationService },
            { type: PromiseUtils },
            { type: HttpUtils },
            { type: String, decorators: [{ type: core.Inject, args: [WHO_AM_I_RESOURCE_URI_TOKEN,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [EVENT_SERVICE,] }] }
        ]; };
    ...
    var HttpAuthInterceptor = /** @class */ (function () {
        ...
        HttpAuthInterceptor.ctorParameters = function () { return [
            ...
            { type: core.Injector },
            { type: HttpUtils },
            { type: String, decorators: [{ type: core.Inject, args: [I18N_RESOURCE_URI_TOKEN,] }] }
        ]; };
    ...
    var HttpInterceptorModule = /** @class */ (function () {
        ...
        HttpInterceptorModule.forRoot = function () {
            ...
            return {
                ...
                providers: __spread(HttpErrorInterceptorClasses, [
                    {
                        provide: http.HTTP_INTERCEPTORS,
    ...
    var HttpPaginationResponseAdapter = /** @class */ (function () {
        ...
        HttpPaginationResponseAdapter.transform = function (ev) {
            ...
            return foundKey
                ? event.clone({ body: __assign({}, event.body, { results: event.body[foundKey] }) })
                : event;
        };
    ...
    var RestClient = /** @class */ (function () {
        ...
        RestClient.prototype.sortByKeys = function (obj) {
            var keys$1 = lodash.sortBy(lodash.keys(obj), function (key) {
                return key;
            });
            return lodash.zipObject(keys$1, lodash.map(keys$1, function (key) {
                return obj[key];
            }));
        };
        ...
        RestClient.prototype.buildRequestHeaders = function (headers) {
            return new http.HttpHeaders(__assign({}, this.DEFAULT_HEADERS, headers));
        };
        return RestClient;
    }());
    ...
    var BrowserService = /** @class */ (function () {
        function BrowserService() {
            ...
            */
            ...
            this.isIE = function () {
                return _this.getCurrentBrowser() === exports.SUPPORTED_BROWSERS.IE;
            };
            this.isFF = function () {
                return _this.getCurrentBrowser() === exports.SUPPORTED_BROWSERS.FIREFOX;
            };
            this.isSafari = function () {
                return _this.getCurrentBrowser() === exports.SUPPORTED_BROWSERS.SAFARI;
            };
        }
    ...
    var TranslateHttpLoader = /** @class */ (function () {
        ...
        TranslateHttpLoader.ctorParameters = function () { return [
    ...
    var LoginDialogComponent = /** @class */ (function () {
        ...
        LoginDialogComponent.prototype.signinWithCredentials = function () {
            ...
            var payload = __assign({}, (this.data.clientCredentials || {}), { username: this.form.get('username').value, password: this.form.get('password').value, grant_type: 'password' });
        ...
        LoginDialogComponent.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [LoginDialogResourceProvider,] }] }
        ]; };
        __decorate([
        ...
        LoginDialogComponent = __decorate([
            ...
            __param(8, core.Optional()), __param(8, core.Inject(LoginDialogResourceProvider)),
    ...
    var LanguageService = /** @class */ (function () {
        ...
        LanguageService.ctorParameters = function () { return [
            ...
            { type: IStorageService },
            { type: core.Injector },
            { type: undefined, decorators: [{ type: core.Inject, args: [LANGUAGE_SERVICE_CONSTANTS,] }] }
        ]; };
        __decorate([
        ...
        LanguageDropdownHelper.order = function (selectedLanguage, languages, config) {
            ...
            switch (config.strategy) {
                case LanguageSortStrategy.Default:
                    ...
                    return __spread([selectedLanguage], orderedLanguages);
    ...
    var LanguageDropdown = /** @class */ (function () {
        ...
        LanguageDropdown.prototype.ngOnInit = function () {
            ...
            Promise.all([
                ...
                var _b = __read(_a, 2), isoCode = _b[0], languages = _b[1];
    ...
    var LanguageDropdownComponent = /** @class */ (function (_super) {
        ...
        LanguageDropdownComponent.ctorParameters = function () { return [
            { type: LanguageService, decorators: [{ type: core.Inject, args: [LANGUAGE_SERVICE,] }] },
            { type: undefined, decorators: [{ type: core.Inject, args: [EVENT_SERVICE,] }] }
        ]; };
    ...
    var SelectComponent = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChild('popover', { static: false }),
            __metadata("design:type", Object)
    ...
    var AuthenticationService = /** @class */ (function (_super) {
        ...
        AuthenticationService.prototype.filterEntryPoints = function (resource) {
            return this.sharedDataService.get('authenticationMap').then(function (authenticationMap) {
                return functionsUtils
                    .convertToArray(__assign({}, (authenticationMap || {}), DEFAULT_AUTH_MAP))
        ...
        AuthenticationService.prototype._findLoginData = function (resource) {
            ...
            return this.filterEntryPoints(resource).then(function (entryPoints) {
                return Promise.resolve(_this.sharedDataService.get('credentialsMap').then(function (credentialsMap) {
                    var map = __assign({}, (credentialsMap || {}), DEFAULT_CREDENTIALS_MAP);
        ...
        AuthenticationService.prototype._launchAuth = function (loginData) {
            ...
            return this.translationsFetchService
                ...
                .then(function (_a) {
                var _b = __read(_a, 2), isFullScreen = _b[0], ssoEnabled = _b[1];
                var modalRef = _this.modalService.open({
                    component: LoginDialogComponent,
                    data: __assign({}, loginData, { isFullScreen: isFullScreen,
    ...
    var FundamentalModalManagerService = /** @class */ (function () {
        function FundamentalModalManagerService(modalRef) {
            ...
            this.component = new rxjs.BehaviorSubject({});
            this.isDismissButtonVisible = new rxjs.BehaviorSubject(true);
        ...
        FundamentalModalManagerService.prototype.addButton = function (button) {
            this.buttons.next(__spread(this.buttons.value, [button]));
        };
        ...
        FundamentalModalManagerService.prototype.disableButton = function (id) {
            this.buttons.next(this.buttons.value.map(function (button) {
                return button.id === id ? __assign({}, button, { disabled: true }) : button;
            }));
        };
        ...
        FundamentalModalManagerService.prototype.enableButton = function (id) {
            this.buttons.next(this.buttons.value.map(function (button) {
                return button.id === id ? __assign({}, button, { disabled: false }) : button;
            }));
        };
    ...
    var FundamentalModalTemplateComponent = /** @class */ (function () {
        function FundamentalModalTemplateComponent(modalManager) {
        ...
        FundamentalModalTemplateComponent.prototype.hasButtons = function () {
            return this.buttons.pipe(operators.map(function (buttons) { return buttons && !!buttons.length; }));
        };
        FundamentalModalTemplateComponent.ctorParameters = function () { return [
    ...
    var ModalService = /** @class */ (function () {
        ...
        ModalService.prototype.openStandalone = function (options) {
            ...
            return this.fundamentalModalService.open(component, __assign({}, config, { data: data }));
        };
        ModalService.prototype.openWithTemplate = function (options) {
            ...
            var settings = __assign({}, config, { data: {
    ...
    var AlertFactory = /** @class */ (function () {
        ...
        AlertFactory.ctorParameters = function () { return [
            { type: core$2.AlertService },
            { type: core$1.TranslateService },
            { type: core$2.AlertConfig, decorators: [{ type: core.Inject, args: [ALERT_CONFIG_DEFAULTS_TOKEN,] }] }
        ]; };
    ...
    var ɵ0$2 = ALERT_CONFIG_DEFAULTS;
    ...
    var FormField = /** @class */ (function (_super) {
        ...
        function FormField(component, control, inputs, persist, validators) {
            if (validators === void 0) { validators = new ValidatorParameters(); }
            var _this = _super.call(this, component, control, inputs, persist) || this;
    ...
    var FormGrouping = /** @class */ (function (_super) {
        ...
        FormGrouping.prototype.addFormElement = function (name, form) {
            var _a;
            this.forms = __assign({}, this.forms, (_a = {}, _a[name] = form, _a));
        ...
        FormGrouping.prototype.removeFormElement = function (name) {
            ...
            var _a = this.forms, _b = name, deleted = _a[_b], forms = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
            this.forms = forms;
            deleted.parent = null;
        ...
        FormGrouping.prototype.setNestedErrors = function (errors) {
            ...
            errors.forEach(function (_a) {
                var _b = __read(_a, 2), path = _b[0], validationErrors = _b[1];
        ...
        FormGrouping.prototype.getPersistedValue = function () {
            ...
            return Object.keys(this.forms).reduce(function (acc, key) {
                 ...
                 */
                if (!child.persist) {
                    return __assign({}, acc, child.getPersistedValue());
                }
    ...
    var FormList = /** @class */ (function (_super) {
        ...
        FormList.prototype.addFormElement = function (form) {
            this.forms = __spread(this.forms, [form]);
        ...
        FormList.prototype.swapFormElements = function (a, b) {
            ...
            this.forms = __spread(this.forms);
            /**
             * Swapping form array.
             */
    ...
    var ControlPropDecorator = /** @class */ (function (_super) {
        __extends(ControlPropDecorator, _super);
    ...
    var FormListerComponent = /** @class */ (function () {
        ...
        Object.defineProperty(FormListerComponent.prototype, "forms", {
            get: function () {
                return lodash.values(this.form.forms);
            },
            enumerable: true,
            configurable: true
        });
    ...
    var ComponentRegistryService = /** @class */ (function (_super) {
        ...
        ComponentRegistryService.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [COMPONENT_MAP,] }] }
        ]; };
        ComponentRegistryService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ComponentRegistryService_Factory() { return new ComponentRegistryService(core.ɵɵinject(COMPONENT_MAP, 8)); }, token: ComponentRegistryService, providedIn: "root" });
    ...
    var AsyncValidatorRegistryService = /** @class */ (function (_super) {
        ...
        AsyncValidatorRegistryService.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [ASYNC_VALIDATOR_MAP,] }] }
        ]; };
        AsyncValidatorRegistryService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function AsyncValidatorRegistryService_Factory() { return new AsyncValidatorRegistryService(core.ɵɵinject(ASYNC_VALIDATOR_MAP, 8)); }, token: AsyncValidatorRegistryService, providedIn: "root" });
    ...
    var ValidatorRegistryService = /** @class */ (function (_super) {
        ...
        ValidatorRegistryService.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [VALIDATOR_MAP,] }] }
        ]; };
        ValidatorRegistryService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ValidatorRegistryService_Factory() { return new ValidatorRegistryService(core.ɵɵinject(VALIDATOR_MAP, 8)); }, token: ValidatorRegistryService, providedIn: "root" });
    ...
    var SchemaCompilerService = /** @class */ (function () {
        ...
        SchemaCompilerService.prototype.compileGroup = function (value, groupSchema, options) {
            ...
            var formGroup = new forms.FormGroup(Object.keys(abstractForms).reduce(function (acc, key) {
        ...
        SchemaCompilerService.prototype.compileList = function (values, schema, options) {
            ...
            var control = new forms.FormArray(list.map(function (form) { return form.control; }));
        ...
        SchemaCompilerService.prototype.compileField = function (value, schema, options) {
            ...
            var formControl = new forms.FormControl({ value: value, disabled: schema.disabled }, validators, asyncValidators);
        ...
        SchemaCompilerService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function SchemaCompilerService_Factory() { return new SchemaCompilerService(core.ɵɵinject(ComponentRegistryService), core.ɵɵinject(ValidatorRegistryService), core.ɵɵinject(AsyncValidatorRegistryService)); }, token: SchemaCompilerService, providedIn: FormBuilderModule });
    ...
    var getPersistenceMap = function (form, map, from, to) {
        ...
        if (form instanceof FormList || form instanceof FormGrouping) {
            ...
            Object.keys(form.forms).forEach(function (current) {
                ...
                var toActual = __spread(to, [current]);
                if (child.persist) {
                    return getPersistenceMap(child, map, __spread(from, [current]), toActual);
                }
    ...
    exports.ControlPropDecorator = ControlPropDecorator;
...
//# sourceMappingURL=smart-utils.umd.js.map
