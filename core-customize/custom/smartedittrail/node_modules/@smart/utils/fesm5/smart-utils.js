...
import { __spread, __decorate, __awaiter, __generator, __metadata, __assign, __param, __read, __extends, __rest } from 'tslib';
...
var CloneableUtils = /** @class */ (function () {
    ...
    CloneableUtils.prototype.makeCloneable = function (_json) {
        var _this = this;
        var json = cloneDeepWith(_json, function (value) {
        ...
        if (params) {
            var _loop_1 = function (param) {
                if (params.hasOwnProperty(param)) {
                    (isArray(params[param]) ? params[param] : [params[param]]).forEach(function (value) {
                        queryString +=
 ...
 * @module smartutils
 */
var commonNgZone = new NgZone({ enableLongStackTrace: false });
...
var LogService = /** @class */ (function () {
    ...
    LogService.prototype._log = function (requestLevel, msg) {
        ...
        if (requestLevel >= this.logLevel) {
            var method = LogLevel[requestLevel];
...
var HttpUtils = /** @class */ (function () {
    ...
    HttpUtils.prototype.buildHttpResponse = function (originalRequest, _statusAndPayload) {
        ...
        return from(statusAndPayloadPromise).pipe(switchMap(function (statusAndPayload) {
            ...
            merge(requestClone, { status: status });
...
var LANGUAGE_SERVICE_CONSTANTS = new InjectionToken('LANGUAGE_SERVICE_CONSTANTS');
var LANGUAGE_SERVICE = new InjectionToken('LANGUAGE_SERVICE');
...
var CacheService = /** @class */ (function () {
    ...
    CacheService.prototype.collectEventNamesFromTags = function (tags) {
        var _this = this;
        if (tags && tags.length) {
            return union.apply(lodash, __spread(tags.map(function (t) { return _this.collectEventNamesFromTag(t); })));
        }
        else {
            return [];
        }
    ...
    CacheService.prototype.collectEventNamesFromTag = function (tag) {
        var _this = this;
        return union.apply(lodash, __spread([[tag.event]], (tag.relatedTags ? tag.relatedTags.map(function (t) { return _this.collectEventNamesFromTag(t); }) : [])));
    };
 ...
 * @module smartutils
 */
var DefaultRetryStrategy = new InjectionToken('DefaultRetryStrategy');
 ...
 * @module smartutils
 */
var ExponentialRetryStrategy = new InjectionToken('ExponentialRetryStrategy');
 ...
 * @module smartutils
 */
var LinearRetryStrategy = new InjectionToken('LinearRetryStrategy');
...
var RestClient = /** @class */ (function () {
    ...
    RestClient.prototype.convertToTypeMapOfString = function (searchParams) {
        return mapValues(searchParams, function (val) { return String(val); });
    };
    ...
    RestClient.prototype.sortByKeys = function (obj) {
        var keys$1 = sortBy(keys(obj), function (key) {
            return key;
        });
        return zipObject(keys$1, map$1(keys$1, function (key) {
            return obj[key];
        }));
    };
    ...
    RestClient.prototype.buildRequestHeaders = function (headers) {
        return new HttpHeaders(__assign({}, this.DEFAULT_HEADERS, headers));
    };
    return RestClient;
}());
...
var RestServiceFactory = /** @class */ (function () {
    ...
    RestServiceFactory.prototype.get = function (uri, identifier) {
        ...
        if (!/^https?\:\/\//.test(uri)) {
            ...
            var basePathURI = isEmpty(newBasePath)
                ? uri
 ...
 * @module smartutils
 */
var LoginDialogResourceProvider = new InjectionToken('LoginDialogResourceProvider');
        ...
        return this._findLoginData(resource).then(function (loginData) {
            return _this._launchAuth(loginData).then(function (modalFeedback) {
                Promise.resolve(_this.eventService.publish(EVENTS.AUTHORIZATION_SUCCESS, {
                     ...
                     */
                    var reauthInProcess = values(_this.reauthInProgress)
...
var FundamentalModalTemplateComponent = /** @class */ (function () {
    ...
    FundamentalModalTemplateComponent.prototype.hasButtons = function () {
        return this.buttons.pipe(map(function (buttons) { return buttons && !!buttons.length; }));
    };
 ...
 * @module smartutils
 */
var ALERT_CONFIG_DEFAULTS_TOKEN = new InjectionToken('alertConfigToken');
var ɵ0$1 = {};
 ...
 * @module smartutils
 */
var COMPONENT_MAP = new InjectionToken('COMPONENT_MAP');
var ASYNC_VALIDATOR_MAP = new InjectionToken('ASYNC_VALIDATOR_MAP');
var VALIDATOR_MAP = new InjectionToken('VALIDATOR_MAP');
