...
module.exports = (function() {
    ...
    paths.tests.smartedittrailContainerTestsRoot =
        paths.tests.testsRoot + '/smartedittrailContainer';
    paths.tests.smartedittrailContainere2eTestsRoot =
        paths.tests.smartedittrailContainerTestsRoot + '/e2e';

    paths.tests.smartedittraile2eTestFiles = paths.tests.root + '/e2e/**/*Test.js';
    paths.tests.smartedittrailContainere2eTestFiles =
        paths.tests.smartedittrailContainere2eTestsRoot + '/**/*Test.js';
