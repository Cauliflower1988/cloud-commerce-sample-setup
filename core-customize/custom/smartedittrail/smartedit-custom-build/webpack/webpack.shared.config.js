...
const commonsAlias = alias(
    ...
    resolve('./jsTarget/web/features/smartedittrailcommons')
);
...
module.exports = {
    ...
    ySmartedit: () =>
        group(
            smartedit,
            entry({
                smartedittrail: resolve('./jsTarget/web/features/smartedittrail/index.ts')
            })
        ),
    ySmarteditContainer: () =>
        group(
            smarteditContainer,
            entry({
                smartedittrailContainer: resolve(
